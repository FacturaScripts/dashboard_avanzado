...
class dashboard_avanzado extends fs_controller
{
    ...
    protected function private_core()
    {
        ...
        foreach ($this->ventas[$this->year]['porc_fam'] as $codfamilia => $porc) {
            ...
            if ($codfamilia != 'SIN_FAMILIA' && isset($this->familias[$codfamilia])) {
    ...
    protected function build_year($year, $codejercicio)
    {
        ...
        $asiento_regularizacion = isset($this->config[$year]['regularizacion']['numero']) ? intval($this->config[$year]['regularizacion']['numero']) : 0;

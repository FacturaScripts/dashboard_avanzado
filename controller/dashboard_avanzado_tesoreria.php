...
class dashboard_avanzado_tesoreria extends fs_controller
{
   ...
   protected function private_core()
   {
      ...
      $this->da_tesoreria = array(
		...
		$this->da_tesoreria["caja1"]=$this->saldo_cuenta('570%1',$this->da_tesoreria["desde"],$this->da_tesoreria["hasta"]);		
		$this->da_tesoreria["caja2"]=$this->saldo_cuenta('570%2',$this->da_tesoreria["desde"],$this->da_tesoreria["hasta"]);
		$this->da_tesoreria["caja3"]=$this->saldo_cuenta('570%3',$this->da_tesoreria["desde"],$this->da_tesoreria["hasta"]);

		$this->da_tesoreria["total_cajas"]=$this->da_tesoreria["caja1"]+$this->da_tesoreria["caja2"]+$this->da_tesoreria["caja3"];



		$this->da_tesoreria["banco1"]=$this->saldo_cuenta('572%1',$this->da_tesoreria["desde"],$this->da_tesoreria["hasta"]);		
		$this->da_tesoreria["banco2"]=$this->saldo_cuenta('572%2',$this->da_tesoreria["desde"],$this->da_tesoreria["hasta"]);
		$this->da_tesoreria["banco3"]=$this->saldo_cuenta('572%3',$this->da_tesoreria["desde"],$this->da_tesoreria["hasta"]);

		$this->da_tesoreria["total_bancos"]=$this->da_tesoreria["banco1"]+$this->da_tesoreria["banco2"]+$this->da_tesoreria["banco3"];
      ...
      $this->da_reservasresultados = array(
		...
		$this->da_reservasresultados["reservasvoluntarias"]=$this->saldo_cuenta('113%',$this->da_reservasresultados["desde"],$this->dda_reservasresultados["hasta"]);
